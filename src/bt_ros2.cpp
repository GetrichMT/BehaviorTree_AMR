...
int main(int argc, char **argv)
{
    ...
    factory.registerNodeType<Camera>("Camera");    
    factory.registerNodeType<MinimalPublisher>("MinimalPublisher");
    factory.registerNodeType<DockingEvent>("DockingEvent");
    factory.registerNodeType<CameraEvent>("CameraEvent");
